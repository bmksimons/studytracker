...
public class Controller {
    ...
    @FXML private ChoiceBox<String> pickCourseDelete;
    ...
    private void updateCourseList() {
    	...
    	pickCourseDelete.setItems(courseList);
    }
	...
	public void deleteCourse() {
		...
		if (courseChosenDelete == null) {
            ...
            if (courseChosenDelete.equals(courseName1.getText())) {
                courseList.remove(courseName1.getText());
                updateCourseList();
                this.semester.removeCourse(courseName1.getText());
                setFieldsEmpty(courseName1, courseTimer1);
                showInformation.setText("Faget er slettet");
                
			} else if (courseChosenDelete.equals(courseName2.getText())) {
				courseList.remove(courseName2.getText());
                updateCourseList();
				this.semester.removeCourse(courseName2.getText());
				setFieldsEmpty(courseName2, courseTimer2);
                showInformation.setText("Faget er slettet");
			} else if (courseChosenDelete.equals(courseName3.getText())) {
				courseList.remove(courseName3.getText());
                updateCourseList();
                this.semester.removeCourse(courseName3.getText());
                courseTimer3.setText("");
                courseName3.setText("");
                showInformation.setText("Faget er slettet");
			} else if (courseChosenDelete.equals(courseName4.getText())) {
				courseList.remove(courseName4.getText());
                updateCourseList();
                this.semester.removeCourse(courseName4.getText());
                courseTimer4.setText("");
                courseName4.setText("");
                showInformation.setText("Faget er slettet");
            }
        }
